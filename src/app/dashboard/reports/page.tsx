    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <p className="text-sm text-blue-700 mt-2">+15.3% from last month</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <p className="text-sm text-sky-700 mt-2">+8.2% from last month</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {['Sales Report', 'Inventory Report', 'Customer Report', 'Product Report', 'Revenue Report', 'Tax Report'].map((report) => (
            <button key={report} className="p-4 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors text-left">
